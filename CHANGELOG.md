...
All notable changes to **kubuno-app** are documented in this file.
...
- **New App logo** — a blue hexagon with a stack of isometric cubes, used as the
...
- **App now authenticates proxied requests from a signed token instead of
  ...
  reaching App's loopback port could otherwise forge to act as any user.

## [0.1.6] - 2026-08-19

[Unreleased]: https://github.com/kubuno/app/compare/v0.1.8...HEAD
[0.1.8]: https://github.com/kubuno/app/releases/tag/v0.1.8
