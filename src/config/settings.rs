...
impl Settings {
    pub fn load() -> Result<Self, ConfigError> {
        let mut builder = Config::builder()
            ...
            .set_default("database.min_connections", 2u64)?
            ...
            .add_source(File::with_name("/etc/kubuno/modules/app/config").required(false));
        ...
        builder = builder
            ...
            .set_override_option("core.files_url",       std::env::var("KUBUNO_FILES_URL").ok())?
        ...
        // Module environment variables (KA__).
        builder = builder.add_source(
            Environment::with_prefix("KA")
                .separator("__")
                .try_parsing(true),
        );
